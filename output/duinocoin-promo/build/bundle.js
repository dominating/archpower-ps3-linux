...
// Module
___CSS_LOADER_EXPORT___.push([module.id, "@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\nbody {\n  font-family: system-ui, -apple-system, sans-serif;\n  margin: 0;\n  padding: 0;\n}\n", "",{"version":3,"sources":["webpack://./src/index.css"],"names":[],"mappings":"AAAA,cAAc;AACd,oBAAoB;AACpB,mBAAmB;;AAEnB;EACE,iDAAiD;EACjD,SAAS;EACT,UAAU;AACZ","sourcesContent":["@tailwind base;\n@tailwind components;\n@tailwind utilities;\n\nbody {\n  font-family: system-ui, -apple-system, sans-serif;\n  margin: 0;\n  padding: 0;\n}\n"],"sourceRoot":""}]);
// Exports
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "duinocoin-promo:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkduinocoin_promo"] = self["webpackChunkduinocoin_promo"] || [];
...
const MyVideo = () => {
  ...
  const bgRotation = (0,cjs.interpolate)(frame, [0, 300], [0, 360]);
  return /* @__PURE__ */ (0,jsx_runtime.jsxs)(cjs.AbsoluteFill, { className: "bg-slate-950 items-center justify-center text-white overflow-hidden font-sans", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)(cjs.AbsoluteFill, { children: [
      ...
      /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "absolute inset-0 bg-black/60 backdrop-blur-3xl" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 0, durationInFrames: 100, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene1, { frame, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 80, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene2, { frame: frame - 80, fps }) }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.Sequence, { from: 180, durationInFrames: 120, children: /* @__PURE__ */ (0,jsx_runtime.jsx)(Scene3, { frame: frame - 180, fps }) })
  ] });
};
const Scene1 = ({ frame, fps }) => {
  const scale = (0,cjs.spring)({ frame, fps, config: { damping: 14 } });
  const opacity = (0,cjs.interpolate)(frame, [80, 100], [1, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { className: "items-center justify-center", style: { opacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${scale})` }, className: "flex flex-col items-center", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Server, { className: "w-32 h-32 text-orange-500 mb-8" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { className: "text-6xl font-black tracking-tight mb-4", children: "Turn idle hardware" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { className: "text-5xl font-bold text-orange-400", children: "into crypto rewards." })
  ] }) });
};
const Scene2 = ({ frame, fps }) => {
  const scale = (0,cjs.spring)({ frame, fps, config: { damping: 14 } });
  const yOffset = (0,cjs.interpolate)(frame, [0, 20], [100, 0], { extrapolateRight: "clamp", extrapolateLeft: "clamp" });
  const opacity = (0,cjs.interpolate)(frame, [100, 120], [1, 0], { extrapolateRight: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { className: "items-center justify-center", style: { opacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${scale}) translateY(${yOffset}px)` }, className: "flex flex-col items-center bg-slate-900/80 p-16 rounded-3xl border border-slate-800 shadow-2xl", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { className: "flex gap-8 mb-8", children: [
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Cpu, { className: "w-24 h-24 text-blue-400" }),
      /* @__PURE__ */ (0,jsx_runtime.jsx)(Zap, { className: "w-24 h-24 text-yellow-400" })
    ] }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { className: "text-6xl font-black text-white mb-4", children: "Mine DuinoCoin (DUCO)" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h2", { className: "text-4xl text-slate-300", children: "Directly on ESP32-S2 USB Dongles" })
  ] }) });
};
const Scene3 = ({ frame, fps }) => {
  const scale = (0,cjs.spring)({ frame, fps, from: 0.8, to: 1, config: { damping: 14 } });
  const opacity = (0,cjs.interpolate)(frame, [0, 20], [0, 1], { extrapolateLeft: "clamp" });
  return /* @__PURE__ */ (0,jsx_runtime.jsx)(cjs.AbsoluteFill, { className: "items-center justify-center", style: { opacity }, children: /* @__PURE__ */ (0,jsx_runtime.jsxs)("div", { style: { transform: `scale(${scale})` }, className: "flex flex-col items-center", children: [
    /* @__PURE__ */ (0,jsx_runtime.jsx)(Coins, { className: "w-40 h-40 text-orange-500 mb-12 drop-shadow-[0_0_30px_rgba(249,115,22,0.5)]" }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("h1", { className: "text-7xl font-black mb-6", children: "Silent. Headless. Passive." }),
    /* @__PURE__ */ (0,jsx_runtime.jsx)("div", { className: "bg-orange-500/20 text-orange-300 px-8 py-4 rounded-full text-3xl font-bold border border-orange-500/50", children: "Get Started at duinocoin.com" })
  ] }) });
};
