...
#   render <project-dir> [comp] [out]   - Render video
#   still <project-dir> [comp] [out]    - Render single frame
#   preview <project-dir>               - Start dev server
#   list <project-dir>                  - List compositions
#   upgrade <project-dir>               - Upgrade Remotion packages
...
case "$CMD" in
    ...
    help|*)
        ...
        echo "  render <dir>      Render video (mp4/webm/gif)"
        echo "  still <dir>       Render single frame"
