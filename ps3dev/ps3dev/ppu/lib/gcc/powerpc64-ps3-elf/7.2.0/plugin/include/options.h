...
#define OPTION_MASK_CMPB (HOST_WIDE_INT_1U << 3)
#define OPTION_MASK_CRYPTO (HOST_WIDE_INT_1U << 4)
#define OPTION_MASK_DIRECT_MOVE (HOST_WIDE_INT_1U << 5)
#define OPTION_MASK_DLMZB (HOST_WIDE_INT_1U << 6)
#define OPTION_MASK_EABI (HOST_WIDE_INT_1U << 7)
#define OPTION_MASK_EFFICIENT_UNALIGNED_VSX (HOST_WIDE_INT_1U << 8)
#define OPTION_MASK_FLOAT128_KEYWORD (HOST_WIDE_INT_1U << 9)
#define OPTION_MASK_FLOAT128_CVT (HOST_WIDE_INT_1U << 10)
#define OPTION_MASK_FLOAT128_HW (HOST_WIDE_INT_1U << 11)
#define OPTION_MASK_FLOAT128_TYPE (HOST_WIDE_INT_1U << 12)
...
#define OPTION_MASK_LRA (HOST_WIDE_INT_1U << 18)
#define OPTION_MASK_MFCRF (HOST_WIDE_INT_1U << 19)
#define OPTION_MASK_MFPGPR (HOST_WIDE_INT_1U << 20)
#define OPTION_MASK_MINIMAL_TOC (HOST_WIDE_INT_1U << 21)
...
#define OPTION_MASK_POPCNTB (HOST_WIDE_INT_1U << 26)
#define OPTION_MASK_POPCNTD (HOST_WIDE_INT_1U << 27)
#define OPTION_MASK_P8_FUSION (HOST_WIDE_INT_1U << 28)
#define OPTION_MASK_P8_FUSION_SIGN (HOST_WIDE_INT_1U << 29)
#define OPTION_MASK_P8_VECTOR (HOST_WIDE_INT_1U << 30)
#define OPTION_MASK_P9_DFORM_SCALAR (HOST_WIDE_INT_1U << 31)
#define OPTION_MASK_P9_DFORM_VECTOR (HOST_WIDE_INT_1U << 32)
#define OPTION_MASK_P9_FUSION (HOST_WIDE_INT_1U << 33)
#define OPTION_MASK_P9_MINMAX (HOST_WIDE_INT_1U << 34)
#define OPTION_MASK_P9_MISC (HOST_WIDE_INT_1U << 35)
#define OPTION_MASK_P9_VECTOR (HOST_WIDE_INT_1U << 36)
#define OPTION_MASK_PPC_GFXOPT (HOST_WIDE_INT_1U << 37)
#define OPTION_MASK_PPC_GPOPT (HOST_WIDE_INT_1U << 38)
#define OPTION_MASK_POWERPC64 (HOST_WIDE_INT_1U << 39)
#define OPTION_MASK_QUAD_MEMORY (HOST_WIDE_INT_1U << 40)
#define OPTION_MASK_QUAD_MEMORY_ATOMIC (HOST_WIDE_INT_1U << 41)
#define OPTION_MASK_RECIP_PRECISION (HOST_WIDE_INT_1U << 42)
#define OPTION_MASK_RELOCATABLE (HOST_WIDE_INT_1U << 43)
#define OPTION_MASK_SAVE_TOC_INDIRECT (HOST_WIDE_INT_1U << 44)
#define OPTION_MASK_STRICT_ALIGN (HOST_WIDE_INT_1U << 45)
#define OPTION_MASK_STRING (HOST_WIDE_INT_1U << 46)
#define OPTION_MASK_TOC_FUSION (HOST_WIDE_INT_1U << 47)
#define OPTION_MASK_UPPER_REGS_DF (HOST_WIDE_INT_1U << 48)
#define OPTION_MASK_UPPER_REGS_DI (HOST_WIDE_INT_1U << 49)
#define OPTION_MASK_UPPER_REGS_SF (HOST_WIDE_INT_1U << 50)
#define OPTION_MASK_VSX (HOST_WIDE_INT_1U << 51)
#define OPTION_MASK_VSX_SMALL_INTEGER (HOST_WIDE_INT_1U << 52)
#define OPTION_MASK_VSX_TIMODE (HOST_WIDE_INT_1U << 53)
...
#define TARGET_FLOAT128_TYPE ((rs6000_isa_flags & OPTION_MASK_FLOAT128_TYPE) != 0)
#define TARGET_FLOAT128_TYPE_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_FLOAT128_TYPE) != 0)
...
#define TARGET_UPPER_REGS_DI ((rs6000_isa_flags & OPTION_MASK_UPPER_REGS_DI) != 0)
#define TARGET_UPPER_REGS_DI_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_UPPER_REGS_DI) != 0)
...
#define TARGET_VSX_SMALL_INTEGER ((rs6000_isa_flags & OPTION_MASK_VSX_SMALL_INTEGER) != 0)
#define TARGET_VSX_SMALL_INTEGER_P(rs6000_isa_flags) (((rs6000_isa_flags) & OPTION_MASK_VSX_SMALL_INTEGER) != 0)
...
enum opt_code
{
  ...
  OPT_m32 = 1151,                            /* -m32 */
  OPT_m64 = 1152,                            /* -m64 */
  OPT_mabi_altivec = 1153,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1154,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1155,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1156,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1157,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1158,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1159,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1160,                /* -mabi=no-altivec */
  OPT_mabi_no_spe = 1161,                    /* -mabi=no-spe */
  OPT_mabi_spe = 1162,                       /* -mabi=spe */
  OPT_mads = 1163,                           /* -mads */
  OPT_maix_struct_return = 1164,             /* -maix-struct-return */
  OPT_malign_ = 1165,                        /* -malign- */
  OPT_malign_branch_targets = 1166,          /* -malign-branch-targets */
  OPT_mallow_df_permute = 1167,              /* -mallow-df-permute */
  OPT_mallow_movmisalign = 1168,             /* -mallow-movmisalign */
  OPT_maltivec = 1169,                       /* -maltivec */
  OPT_maltivec_be = 1170,                    /* -maltivec=be */
  OPT_maltivec_le = 1171,                    /* -maltivec=le */
  OPT_malways_hint = 1172,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1173,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1174,                           /* -mbig */
  OPT_mbig_endian = 1175,                    /* -mbig-endian */
  OPT_mbit_align = 1176,                     /* -mbit-align */
  OPT_mbit_word = 1177,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1178,   /* -mblock-compare-inline-limit= */
  OPT_mblock_move_inline_limit_ = 1179,      /* -mblock-move-inline-limit= */
  OPT_mbss_plt = 1180,                       /* -mbss-plt */
  OPT_mcall_ = 1181,                         /* -mcall- */
  OPT_mcmpb = 1182,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1183,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1184,                          /* -mcpu= */
  OPT_mcrypto = 1185,                        /* -mcrypto */
  OPT_mdebug_ = 1186,                        /* -mdebug= */
  OPT_mdirect_move = 1187,                   /* -mdirect-move */
  OPT_mdlmzb = 1188,                         /* -mdlmzb */
  OPT_mdouble_float = 1189,                  /* -mdouble-float */
  OPT_meabi = 1190,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1191,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1192,                           /* -memb */
  OPT_mfloat_gprs_ = 1193,                   /* -mfloat-gprs= */
  OPT_mfloat128 = 1194,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1195,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1196,             /* -mfloat128-hardware */
  OPT_mfloat128_type = 1197,                 /* -mfloat128-type */
  OPT_mfp_in_toc = 1198,                     /* -mfp-in-toc */
  OPT_mfprnd = 1199,                         /* -mfprnd */
  OPT_mfpu_ = 1200,                          /* -mfpu= */
  OPT_mfriz = 1201,                          /* -mfriz */
  OPT_mfull_toc = 1202,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1203, */              /* -mfused-madd */
  OPT_mgen_cell_microcode = 1204,            /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 1205,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1206,                      /* -mhard-dfp */
  OPT_mhard_float = 1207,                    /* -mhard-float */
  OPT_mhtm = 1208,                           /* -mhtm */
  OPT_minsert_sched_nops_ = 1209,            /* -minsert-sched-nops= */
  OPT_misel = 1210,                          /* -misel */
  /* OPT_misel_no = 1211, */                 /* -misel=no */
  /* OPT_misel_yes = 1212, */                /* -misel=yes */
  OPT_mlittle = 1213,                        /* -mlittle */
  OPT_mlittle_endian = 1214,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1215,                  /* -mlong-double- */
  OPT_mlongcall = 1216,                      /* -mlongcall */
  OPT_mlra = 1217,                           /* -mlra */
  OPT_mmfcrf = 1218,                         /* -mmfcrf */
  OPT_mmfpgpr = 1219,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1220,                   /* -mminimal-toc */
  OPT_mmodulo = 1221,                        /* -mmodulo */
  OPT_mmulhw = 1222,                         /* -mmulhw */
  OPT_mmultiple = 1223,                      /* -mmultiple */
  OPT_mmvme = 1224,                          /* -mmvme */
  OPT_mnewlib = 1225,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1226,                  /* -mno-fp-in-toc */
  OPT_mno_sum_in_toc = 1227,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1228,                        /* -mno-toc */
  OPT_mno_traceback = 1229,                  /* -mno-traceback */
  OPT_mno_update = 1230,                     /* -mno-update */
  OPT_moptimize_swaps = 1231,                /* -moptimize-swaps */
  OPT_mpaired = 1232,                        /* -mpaired */
  OPT_mpointers_to_nested_functions = 1233,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1234,                       /* -mpopcntb */
  OPT_mpopcntd = 1235,                       /* -mpopcntd */
  OPT_mpower8_fusion = 1236,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1237,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1238,                 /* -mpower8-vector */
  OPT_mpower9_dform = 1239,                  /* -mpower9-dform */
  OPT_mpower9_dform_scalar = 1240,           /* -mpower9-dform-scalar */
  OPT_mpower9_dform_vector = 1241,           /* -mpower9-dform-vector */
  OPT_mpower9_fusion = 1242,                 /* -mpower9-fusion */
  OPT_mpower9_minmax = 1243,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1244,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1245,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1246, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1247,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1248,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1249,                     /* -mpowerpc64 */
  OPT_mprioritize_restricted_insns_ = 1250,  /* -mprioritize-restricted-insns= */
  OPT_mprototype = 1251,                     /* -mprototype */
  OPT_mquad_memory = 1252,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1253,            /* -mquad-memory-atomic */
  OPT_mrecip = 1254,                         /* -mrecip */
  OPT_mrecip_precision = 1255,               /* -mrecip-precision */
  OPT_mrecip_ = 1256,                        /* -mrecip= */
  OPT_mregnames = 1257,                      /* -mregnames */
  OPT_mrelocatable = 1258,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 1259,               /* -mrelocatable-lib */
  OPT_msave_toc_indirect = 1260,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 1261,             /* -msched-costly-dep= */
  OPT_msched_epilog = 1262,                  /* -msched-epilog */
  OPT_msched_groups = 1263,                  /* -msched-groups */
  OPT_msched_prolog = 1264,                  /* -msched-prolog */
  OPT_msdata = 1265,                         /* -msdata */
  OPT_msdata_ = 1266,                        /* -msdata= */
  OPT_msecure_plt = 1267,                    /* -msecure-plt */
  OPT_mshlib = 1268,                         /* -mshlib */
  OPT_msim = 1269,                           /* -msim */
  OPT_msimple_fpu = 1270,                    /* -msimple-fpu */
  OPT_msingle_float = 1271,                  /* -msingle-float */
  OPT_msingle_pic_base = 1272,               /* -msingle-pic-base */
  OPT_msoft_float = 1273,                    /* -msoft-float */
  OPT_mspe = 1274,                           /* -mspe */
  /* OPT_mspe_no = 1275, */                  /* -mspe=no */
  /* OPT_mspe_yes = 1276, */                 /* -mspe=yes */
  OPT_mstack_protector_guard_offset_ = 1277, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1278,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 1279,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 1280,                  /* -mstrict-align */
  OPT_mstring = 1281,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 1282,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 1283,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 1284,            /* -msvr4-struct-return */
  OPT_mtls_markers = 1285,                   /* -mtls-markers */
  OPT_mtls_size_ = 1286,                     /* -mtls-size= */
  OPT_mtoc = 1287,                           /* -mtoc */
  OPT_mtoc_fusion = 1288,                    /* -mtoc-fusion */
  OPT_mtraceback_ = 1289,                    /* -mtraceback= */
  OPT_mtune_ = 1290,                         /* -mtune= */
  OPT_mupdate = 1291,                        /* -mupdate */
  OPT_mupper_regs = 1292,                    /* -mupper-regs */
  OPT_mupper_regs_df = 1293,                 /* -mupper-regs-df */
  OPT_mupper_regs_di = 1294,                 /* -mupper-regs-di */
  OPT_mupper_regs_sf = 1295,                 /* -mupper-regs-sf */
  OPT_mveclibabi_ = 1296,                    /* -mveclibabi= */
  OPT_mvectorize_builtins = 1297,            /* -mvectorize-builtins */
  OPT_mvrsave = 1298,                        /* -mvrsave */
  /* OPT_mvrsave_no = 1299, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 1300, */              /* -mvrsave=yes */
  OPT_mvsx = 1301,                           /* -mvsx */
  OPT_mvsx_align_128 = 1302,                 /* -mvsx-align-128 */
  OPT_mvsx_scalar_double = 1303,             /* -mvsx-scalar-double */
  OPT_mvsx_scalar_float = 1304,              /* -mvsx-scalar-float */
  /* OPT_mvsx_scalar_memory = 1305, */       /* -mvsx-scalar-memory */
  OPT_mvsx_small_integer = 1306,             /* -mvsx-small-integer */
  OPT_mvsx_timode = 1307,                    /* -mvsx-timode */
  OPT_mwarn_altivec_long = 1308,             /* -mwarn-altivec-long */
  OPT_mwarn_cell_microcode = 1309,           /* -mwarn-cell-microcode */
  OPT_mxilinx_fpu = 1310,                    /* -mxilinx-fpu */
  OPT_mxl_compat = 1311,                     /* -mxl-compat */
  OPT_myellowknife = 1312,                   /* -myellowknife */
  OPT_n = 1313,                              /* -n */
  ...
  OPT_pie = 1329,                            /* -pie */
  OPT_pipe = 1330,                           /* -pipe */
  OPT_print_file_name_ = 1331,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1332,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1333,          /* -print-multi-directory */
  OPT_print_multi_lib = 1334,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1335,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1336,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1337,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1338,               /* -print-prog-name= */
  OPT_print_search_dirs = 1339,              /* -print-search-dirs */
  OPT_print_sysroot = 1340,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1341,   /* -print-sysroot-headers-suffix */
