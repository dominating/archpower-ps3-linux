...
#define MASK_ADDRESS_SPACE_CONVERSION (1U << 0)
#define MASK_BRANCH_HINTS (1U << 1)
#define MASK_ERROR_RELOC (1U << 2)
#define MASK_LARGE_MEM (1U << 3)
#define MASK_SAFE_DMA (1U << 4)
#define MASK_SAFE_HINTS (1U << 5)
#define MASK_STD_MAIN (1U << 6)
#define MASK_WARN_RELOC (1U << 7)

#define TARGET_ADDRESS_SPACE_CONVERSION ((target_flags & MASK_ADDRESS_SPACE_CONVERSION) != 0)
#define TARGET_ADDRESS_SPACE_CONVERSION_P(target_flags) (((target_flags) & MASK_ADDRESS_SPACE_CONVERSION) != 0)
#define TARGET_BRANCH_HINTS ((target_flags & MASK_BRANCH_HINTS) != 0)
#define TARGET_BRANCH_HINTS_P(target_flags) (((target_flags) & MASK_BRANCH_HINTS) != 0)
#define TARGET_ERROR_RELOC ((target_flags & MASK_ERROR_RELOC) != 0)
#define TARGET_ERROR_RELOC_P(target_flags) (((target_flags) & MASK_ERROR_RELOC) != 0)
#define TARGET_LARGE_MEM ((target_flags & MASK_LARGE_MEM) != 0)
#define TARGET_LARGE_MEM_P(target_flags) (((target_flags) & MASK_LARGE_MEM) != 0)
#define TARGET_SAFE_DMA ((target_flags & MASK_SAFE_DMA) != 0)
#define TARGET_SAFE_DMA_P(target_flags) (((target_flags) & MASK_SAFE_DMA) != 0)
#define TARGET_SAFE_HINTS ((target_flags & MASK_SAFE_HINTS) != 0)
#define TARGET_SAFE_HINTS_P(target_flags) (((target_flags) & MASK_SAFE_HINTS) != 0)
#define TARGET_STD_MAIN ((target_flags & MASK_STD_MAIN) != 0)
#define TARGET_STD_MAIN_P(target_flags) (((target_flags) & MASK_STD_MAIN) != 0)
#define TARGET_WARN_RELOC ((target_flags & MASK_WARN_RELOC) != 0)
#define TARGET_WARN_RELOC_P(target_flags) (((target_flags) & MASK_WARN_RELOC) != 0)
...
enum opt_code
{
  ...
  OPT_maddress_space_conversion = 1150,      /* -maddress-space-conversion */
  OPT_march_ = 1151,                         /* -march= */
  OPT_matomic_updates = 1152,                /* -matomic-updates */
  OPT_mbranch_cost_ = 1153,                  /* -mbranch-cost= */
  OPT_mbranch_hints = 1154,                  /* -mbranch-hints */
  OPT_mcache_size_ = 1155,                   /* -mcache-size= */
  OPT_mdual_nops = 1156,                     /* -mdual-nops */
  OPT_mdual_nops_ = 1157,                    /* -mdual-nops= */
  OPT_mea32 = 1158,                          /* -mea32 */
  OPT_mea64 = 1159,                          /* -mea64 */
  OPT_merror_reloc = 1160,                   /* -merror-reloc */
  OPT_mfixed_range_ = 1161,                  /* -mfixed-range= */
  OPT_mhint_max_distance_ = 1162,            /* -mhint-max-distance= */
  OPT_mhint_max_nops_ = 1163,                /* -mhint-max-nops= */
  OPT_mlarge_mem = 1164,                     /* -mlarge-mem */
  OPT_msafe_dma = 1165,                      /* -msafe-dma */
  OPT_msafe_hints = 1166,                    /* -msafe-hints */
  OPT_msmall_mem = 1167,                     /* -msmall-mem */
  OPT_mstdmain = 1168,                       /* -mstdmain */
  OPT_mtune_ = 1169,                         /* -mtune= */
  OPT_munsafe_dma = 1170,                    /* -munsafe-dma */
  OPT_mwarn_reloc = 1171,                    /* -mwarn-reloc */
  OPT_n = 1172,                              /* -n */
  OPT_no_canonical_prefixes = 1173,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1174,              /* -no-integrated-cpp */
  OPT_no_pie = 1175,                         /* -no-pie */
  ...
  OPT_static_libgfortran = 1214,             /* -static-libgfortran */
  OPT_static_libgo = 1215,                   /* -static-libgo */
  OPT_static_liblsan = 1216,                 /* -static-liblsan */
  OPT_static_libmpx = 1217,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 1218,          /* -static-libmpxwrappers */
  OPT_static_libstdc__ = 1219,               /* -static-libstdc++ */
  OPT_static_libtsan = 1220,                 /* -static-libtsan */
  OPT_static_libubsan = 1221,                /* -static-libubsan */
  /* OPT_std_c__03 = 1222, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1223, */                /* -std=c++0x */
  OPT_std_c__11 = 1224,                      /* -std=c++11 */
  OPT_std_c__14 = 1225,                      /* -std=c++14 */
  /* OPT_std_c__17 = 1226, */                /* -std=c++17 */
  /* OPT_std_c__1y = 1227, */                /* -std=c++1y */
  OPT_std_c__1z = 1228,                      /* -std=c++1z */
  OPT_std_c__98 = 1229,                      /* -std=c++98 */
  OPT_std_c11 = 1230,                        /* -std=c11 */
  /* OPT_std_c1x = 1231, */                  /* -std=c1x */
  /* OPT_std_c89 = 1232, */                  /* -std=c89 */
  OPT_std_c90 = 1233,                        /* -std=c90 */
  OPT_std_c99 = 1234,                        /* -std=c99 */
  /* OPT_std_c9x = 1235, */                  /* -std=c9x */
  OPT_std_f2003 = 1236,                      /* -std=f2003 */
  OPT_std_f2008 = 1237,                      /* -std=f2008 */
  OPT_std_f2008ts = 1238,                    /* -std=f2008ts */
  OPT_std_f95 = 1239,                        /* -std=f95 */
  OPT_std_gnu = 1240,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 1241, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 1242, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 1243,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 1244,                    /* -std=gnu++14 */
  /* OPT_std_gnu__17 = 1245, */              /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 1246, */              /* -std=gnu++1y */
  OPT_std_gnu__1z = 1247,                    /* -std=gnu++1z */
  ...
  OPT_symbolic = 1261,                       /* -symbolic */
  OPT_t = 1262,                              /* -t */
  OPT_time = 1263,                           /* -time */
  OPT_time_ = 1264,                          /* -time= */
  OPT_traditional = 1265,                    /* -traditional */
  OPT_traditional_cpp = 1266,                /* -traditional-cpp */
  OPT_trigraphs = 1267,                      /* -trigraphs */
  OPT_u = 1268,                              /* -u */
  OPT_undef = 1269,                          /* -undef */
  OPT_v = 1270,                              /* -v */
  OPT_version = 1271,                        /* -version */
  OPT_w = 1272,                              /* -w */
  OPT_wrapper = 1273,                        /* -wrapper */
  OPT_x = 1274,                              /* -x */
  OPT_z = 1275,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
