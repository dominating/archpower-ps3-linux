...
extern int const_one_operand (rtx, machine_mode);
extern int spu_reg_operand (rtx, machine_mode);
extern int spu_nonimm_operand (rtx, machine_mode);
extern int spu_nonmem_operand (rtx, machine_mode);
extern int spu_mov_operand (rtx, machine_mode);
extern int spu_dest_operand (rtx, machine_mode);
extern int call_operand (rtx, machine_mode);
extern int vec_imm_operand (rtx, machine_mode);
extern int spu_arith_operand (rtx, machine_mode);
extern int spu_logical_operand (rtx, machine_mode);
extern int spu_ior_operand (rtx, machine_mode);
extern int imm_K_operand (rtx, machine_mode);
extern int branch_comparison_operator (rtx, machine_mode);
extern int spu_inv_exp2_operand (rtx, machine_mode);
extern int spu_exp2_operand (rtx, machine_mode);
extern int shiftrt_operator (rtx, machine_mode);
...
{
  return c >= CONSTRAINT_m && c <= CONSTRAINT_T;
}
...
{
  if (c >= CONSTRAINT_A && c <= CONSTRAINT_w)
    return;
